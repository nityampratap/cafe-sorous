document.addEventListener('DOMContentLoaded', () => {
  ...
  // ==========================================
  // CUSTOM CURSOR FOLLOWER WITH LERP INERTIA
  // ==========================================
  ...
  function updateCircleCursor() {
    ...
    requestAnimationFrame(updateCircleCursor);
  }
  requestAnimationFrame(updateCircleCursor);

  const hoverTargets = document.querySelectorAll('a, button, .card, .wheel-item, .cube-container, select, input, textarea, .toggle-btn, .tab-link');
